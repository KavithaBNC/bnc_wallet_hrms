...
export const APP_MODULES: AppModule[] = [
  ...
  // { path: '/core-hr/overview', label: 'Overview', resource: 'core_hr', visibility: 'all', parentPath: '/core-hr' }, // temporarily hidden
  ...
  { path: '/payroll/dashboard', label: 'Payroll Dashboard', resource: 'payroll', visibility: 'all', parentPath: '/payroll' },
  { path: '/payroll/run', label: 'Run Payroll', resource: 'payroll', visibility: 'all', parentPath: '/payroll' },
  { path: '/payroll/history', label: 'Payroll History', resource: 'payroll', visibility: 'all', parentPath: '/payroll' },
  ...
  { path: '/payroll/fnf-settlement', label: 'F&F Settlement', resource: 'fnf_settlements', visibility: 'all', parentPath: '/payroll-master' },
  { path: '/payroll/loans', label: 'Loan & Advance', resource: 'employee_loans', visibility: 'all', parentPath: '/payroll-master' },
  { path: '/payroll/employee-rejoin', label: 'Employee Rejoin', resource: 'employee_rejoin', visibility: 'all', parentPath: '/payroll-master' },
  { path: '/salary-structure', label: 'Salary Structure', resource: 'salary_structures', visibility: 'all' },
  { path: '/salary-structures', label: 'Salary Components', resource: 'salary_structures', visibility: 'all', parentPath: '/salary-structure' },
  { path: '/salary-templates', label: 'Salary Templates', resource: 'salary_templates', visibility: 'all', parentPath: '/salary-structure' },
  { path: '/employee-salaries', label: 'Employee Salary', resource: 'employee_salaries', visibility: 'all', parentPath: '/salary-structure' },
  ...
  { path: '/esop/dashboard', label: 'ESOP Dashboard', resource: 'esop', visibility: 'all', parentPath: '/esop' },
  { path: '/esop/pools', label: 'ESOP Pools', resource: 'esop_pools', visibility: 'all', parentPath: '/esop' },
  { path: '/esop/vesting-plans', label: 'Vesting Plans', resource: 'esop_vesting_plans', visibility: 'all', parentPath: '/esop' },
  { path: '/esop/grants', label: 'ESOP Grants', resource: 'esop_grants', visibility: 'all', parentPath: '/esop' },
  { path: '/esop/vesting-schedules', label: 'Vesting Schedule', resource: 'esop_vesting_schedules', visibility: 'all', parentPath: '/esop' },
  { path: '/esop/exercise-requests', label: 'Exercise Requests', resource: 'esop_exercise_requests', visibility: 'all', parentPath: '/esop' },
  { path: '/esop/ledger', label: 'ESOP Ledger', resource: 'esop_ledger', visibility: 'all', parentPath: '/esop' },
  { path: '/esop/my-holdings', label: 'My Holdings', resource: 'esop', visibility: 'all', parentPath: '/esop' },
  ...
  { path: '/statutory', label: 'Statutory Compliance', resource: 'statutory_compliance', visibility: 'all' },
  { path: '/statutory/epf', label: 'EPF Processing', resource: 'epf_processing', visibility: 'all', parentPath: '/statutory' },
  { path: '/statutory/esic', label: 'ESIC Processing', resource: 'esic_processing', visibility: 'all', parentPath: '/statutory' },
  { path: '/statutory/professional-tax', label: 'Professional Tax', resource: 'professional_tax', visibility: 'all', parentPath: '/statutory' },
  { path: '/statutory/tds', label: 'TDS / Income Tax', resource: 'tds_income_tax', visibility: 'all', parentPath: '/statutory' },
  { path: '/reports', label: 'Reports', resource: 'reports', visibility: 'all' },
  { path: '/reports/payroll-register', label: 'Payroll Register', resource: 'reports', visibility: 'all', parentPath: '/reports' },
  { path: '/reports/epf', label: 'EPF Report', resource: 'reports', visibility: 'all', parentPath: '/reports' },
  { path: '/reports/esic', label: 'ESIC Report', resource: 'reports', visibility: 'all', parentPath: '/reports' },
  { path: '/reports/professional-tax', label: 'Professional Tax Report', resource: 'reports', visibility: 'all', parentPath: '/reports' },
  { path: '/reports/tds-working', label: 'TDS Working Report', resource: 'reports', visibility: 'all', parentPath: '/reports' },
  { path: '/reports/form16', label: 'Form 16 Data', resource: 'reports', visibility: 'all', parentPath: '/reports' },
  { path: '/reports/fnf-settlement', label: 'F&F Settlement Report', resource: 'reports', visibility: 'all', parentPath: '/reports' },
];
