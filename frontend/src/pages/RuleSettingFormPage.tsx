  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const payload = {
        ...
        associate: (associate.trim() || null) as string | null,
        paygroupId: selectedPaygroups[0]?.id === '__ALL__' ? null : (selectedPaygroups[0]?.id ?? null),
        departmentId: selectedDepartments[0]?.id === '__ALL__' ? null : (selectedDepartments[0]?.id ?? null),
        priority: 0,
