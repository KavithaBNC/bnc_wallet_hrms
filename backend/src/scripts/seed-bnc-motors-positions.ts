...
const POSITIONS = [
  ...
  'Welder',
  // Newly added BNC Motors designations
  'CTO',
  'VMC Operator',
  'PPC',
  'Tool Maker',
  ...
  'Tool Maker Assistant',
  'Pipe Bending Operator',
  'Assistant',
  'CNC Setter',
  'Supervisor',
  'Wire Cut Operator',
  ...
  'COO',
  'VMC Setter cum Operator',
  'Surface Grinding Setter',
  'Press Shop Setter',
  'Account Executive cum Stores',
  'Project Manager',
  'Pre-Inspection Delivery',
  'Mould Polisher',
  'Helper',
  'Press Shop Incharge',
